...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ cb4cled_design_CB4CLED_Top_0_0_sim_netlist.vhdl
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_singleShot_0 is
  port (
    CS : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_singleShot_0 : entity is "singleShot";
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_singleShot_0;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_singleShot_0 is
  signal \^cs\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CB4CLED_Top is
  port (
    count : out STD_LOGIC_VECTOR ( 3 downto 0 );
    ceo : out STD_LOGIC;
    TC : out STD_LOGIC;
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CB4CLED_Top;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CB4CLED_Top is
  signal CS : STD_LOGIC;
...
begin
  TC <= \^tc\;
  count(3 downto 0) <= \^count\(3 downto 0);
CB4CLED_i: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CB4CLED
     port map (
      CS => CS_0,
...
cePulse_i: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_singleShot
     port map (
      CS => CS,
      TC => \^tc\,
      ce => ce,
...
loadPulse_i: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_singleShot_0
     port map (
      CS => CS_0,
      CS_0 => CS,
      D(0) => NS(0),
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "cb4cled_design_CB4CLED_Top_0_0,CB4CLED_Top,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "CB4CLED_Top,Vivado 2019.1";
...
begin
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CB4CLED_Top
     port map (
      TC => TC,
      ce => ce,
      ceo => ceo,
